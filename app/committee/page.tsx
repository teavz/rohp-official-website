...
export default function CommitteePage() {
  ...
  const committeeMembers: CommitteeMember[] = [
    ...
    },
    {
      ...
      image: "/ROHP CM Biographies (2025-2026) (File responses)/Headshots! (File responses)/Madison Palacios Vera.jpg",
    ...
    },
    {
      ...
      image: "/ROHP CM Biographies (2025-2026) (File responses)/Headshots! (File responses)/Aanya Chakraborty.png",
      secondImage: "/ROHP CM Biographies (2025-2026) (File responses)/Funny-Silly Picture (File responses)/Aanya Chakraborty.png",
    ...
    },
    {
      ...
      image: "/ROHP CM Biographies (2025-2026) (File responses)/Headshots! (File responses)/Connor Lu.jpg",
    ...
    },
    {
      ...
      secondImage: "/ROHP CM Biographies (2025-2026) (File responses)/Funny-Silly Picture (File responses)/Lauren Jungmin Lee.jpg",
